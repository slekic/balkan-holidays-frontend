...
import AllOffers from "./pages/Archive/AllOffers/AllOffers";
import FollowUpOffers from "./pages/Archive/FollowUpOffers/FollowUpOffers";
import Trash from "./pages/Archive/Trash/Trash";
